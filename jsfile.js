...
for( i=1; i<7; i++)
{
    num1=Math.ceil(Math.random() * i);
    document.getElementById('viewbox1').innerHTML = ('<img src="' + randomImage[num1] + '" />');
    num2=Math.ceil(Math.random() * i);
    document.getElementById('viewbox2').innerHTML = ('<img src="' + randomImage[num2] + '" />');
}
